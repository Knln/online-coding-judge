...
class Solution:
    ...
    def move_smallest(list):
        ...
        element = list.pop(smallest_index)
    ...
    def networkDelayTime(self, times: List[List[int]], n: int, k: int) -> int:
        ...
        while queue:
            ...
            queue = Solution.move_smallest(queue)
